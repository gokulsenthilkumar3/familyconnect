      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]">
        <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-blue-50 to-purple-50">
          <div className="flex items-center text-purple-700">
            ...
            <h2 className="text-xl font-bold">AI Family Historian</h2>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto flex-1">
          ...
          <button 
            ...
            className="mt-3 flex items-center text-sm font-medium text-purple-600 hover:text-purple-700"
          >
            <Plus size={16} className="mr-1" /> Add another fact
          </button>
        </div>
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex justify-end space-x-3 bg-gray-50">
          ...
          <Button 
            ...
            leftIcon={isGenerating ? <div className="animate-spin h-4 w-4 border-2 border-white border-t-transparent rounded-full" /> : <Sparkles size={18} />}
          >
